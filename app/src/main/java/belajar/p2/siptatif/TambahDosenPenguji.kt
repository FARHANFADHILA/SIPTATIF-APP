...
class TambahDosenPenguji : ComponentActivity() {
                ...
                Surface(
                    ...
                    Scaffold(
                        topBar = { TopAppBar(
                            ...
                            title = { Text(text = "TAMBAH", textAlign = TextAlign.Center, modifier = Modifier.fillMaxWidth())},
                            navigationIcon = {
                        ...
                        Column(modifier = Modifier.padding(top=80.dp)){
                            ...
                            Row(modifier = Modifier.align(Alignment.CenterHorizontally)){
                                MyTheme {
                                    ...
                                    Button(onClick = {
                                                     val tobrd = Intent(this@TambahDosenPenguji, Beranda::class.java)
                                        startActivity(tobrd)
                                        Toast.makeText(this@TambahDosenPenguji, "TERSIMPAN", Toast.LENGTH_SHORT).show()
...
fun Input() {
    ...
    var textnip by remember { mutableStateOf(TextFieldValue("")) }
    var textkuota by remember { mutableStateOf(TextFieldValue("")) }
    var textkeahlian by remember { mutableStateOf(TextFieldValue("")) }
    Column {
